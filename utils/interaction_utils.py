...
def process_user_prompt(previous_interactions, conversation_log):
    ...
    try:
        ...
        ai_response, previous_interactions, tokens_used = generate_ai_response(system_prompt, user_prompt, previous_interactions)
