SYSTEM_PROMPT = "You are a helpful assistant with expertise in software engineering and entrepreneurship."

USER_PROMPT_SUMMARY = """
I am analyzing an open-source GitHub repository named '{repo_name}'. The repository's README file is as follows:
